      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            <div className="truncate font-semibold text-zinc-100">Véhicule {vehicle.label}</div>
            <div className="truncate text-sm text-zinc-400">{vehicle.route?.longName ?? 'Ligne non renseignée'}</div>
          </div>
        </div>
